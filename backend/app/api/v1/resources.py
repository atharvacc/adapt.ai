    ...
    _DEMO_RULE_SETS = [
        ...
        },
        {
            ...
            "rules": [
                ...
                {"name": "TikTok: 2200 chars", "type": "format", "enforcement": "required",
                 "description": "TikTok descriptions must not exceed 2200 characters."},
                {"name": "Hashtag limits", "type": "format", "enforcement": "suggested",
                 "description": "X: 2-3 hashtags max. LinkedIn: 3-5. Instagram: 5-15. TikTok: 3-5. Always place hashtags at end."},
        ...
        },
        {
            ...
            "rules": [
                ...
                {"name": "Conversational formality", "type": "tone", "enforcement": "suggested",
                 "description": "LinkedIn: professional but approachable. X: casual and punchy. Instagram: warm and visual. TikTok: energetic and direct."},
                {"name": "No excessive emojis", "type": "tone", "enforcement": "suggested",
                 "description": "LinkedIn: 0-2 emojis. X: 0-1. Instagram: 3-5 maximum. TikTok: 2-4. Never use emojis in the middle of sentences."},
                {"name": "Sentence length", "type": "tone", "enforcement": "suggested",
                 "description": "Keep sentences under 20 words on X and TikTok. LinkedIn allows up to 30 words per sentence."},
            ],
        },
    ]
